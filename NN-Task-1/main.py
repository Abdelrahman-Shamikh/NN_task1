...
data = pd.read_csv(r"C:\Users\LENOVO\Desktop\NN Task 1\birds.csv")
...
def selectFeaturesFromGUI(feature1, feature2, class_selection):
    ...
    if feature1 not in data.columns or feature2 not in data.columns:
        raise ValueError("Selected features are not in the dataset")
...
def evaluate_performance(test_data, weights, bias):
    tp, fp, tn, fn = 0, 0, 0, 0
...
def start_perceptron():
    ...
    evaluate_performance(te, w, bias)
